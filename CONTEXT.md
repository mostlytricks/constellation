...
## Current State
- Seam at **v1** (still provisional — synthetic evidence only: orion + meridian). Three template families, two themes, all committed deck-specs on v1, machine green end-to-end.
